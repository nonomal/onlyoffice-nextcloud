OC.L10N.register(
    ...
    "Global filter": "Глобален филтър",
    "group": "група",
    "Advanced": "Допълнително",
    "Provide advanced document permissions using ONLYOFFICE Docs": "Предоставете нови разрешения за документи с помощта на ONLYOFFICE Docs",
    ...
    "Select file to insert text": "Изберете файл за вмъкване на текст",
    ...
    "Are you sure you want to clear metadata?": "Сигурни ли сте, че искате да изчистите метаданните?",
    "Confirm metadata removal": "Потвърдете премахването на метаданните",
    "Welcome to ONLYOFFICE Docs!": "Добре дошли в ONLYOFFICE Docs!",
    "Edit and collaborate on text documents, spreadsheets, presentations, and PDFs within Nextcloud using ONLYOFFICE Docs.": "Редактирайте и си сътрудничете върху текстови документи, електронни таблици, презентации и PDF файлове в Nextcloud с помощта на ONLYOFFICE Docs.",
    "Learn more": "Научете повече",
    "Suggest a feature": "Предложете функция",
    "Server settings have been successfully updated": "Настройките на сървъра са актуализирани успешно",
    "Common settings have been successfully updated": "Общите настройки са актуализирани успешно",
    "Security settings have been successfully updated": "Настройките за сигурност са актуализирани успешно",
    "To ensure the security of important parameters in ONLYOFFICE Docs requests, please set a Secret Key on the Settings page. To learn more, <a href=\"{url}\" target=\"_blank\">click here</a>.": "За да гарантирате сигурността на важните параметри в заявките на ONLYOFFICE Docs, моля задайте секретен ключ на страницата с настройки. За да научите повече, <a href=\"{url}\" target=\"_blank\">кликнете тук</a>.",
    "Info": "Информация",
    "Open": "Отвори",
    "%1$s could not be saved. Please open the file again.": "%1$s не можа да бъде запазен. Моля, отворете файла отново.",
    "{file} could not be saved. Please open the file again.": "{file} не можа да бъде запазен. Моля, отворете файла отново.",
    ...
    "Mailing is completed with some errors": "Изпращането е завършено с някои грешки",
    "Files. Mailing is completed successfully": "Файлове. Изпращането е завършено успешно",
    "Files. Mailing is completed with some errors.\n At least %1$s mail messages could not be sent. Please check the Mail module to review the reasons for the failure.": "Файлове. Изпращането е завършено с някои грешки.\n Поне %1$s имейл съобщения не можаха да бъдат изпратени. Моля, проверете модула за поща, за да прегледате причините за неуспеха.",
