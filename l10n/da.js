OC.L10N.register(
    ...
    "Confirm metadata removal": "Bekræft fjernelse af metadata",
    "Welcome to ONLYOFFICE Docs!": "Velkommen til ONLYOFFICE Docs!",
    "Edit and collaborate on text documents, spreadsheets, presentations, and PDFs within Nextcloud using ONLYOFFICE Docs.": "Rediger og samarbejd om tekstdokumenter, regneark, præsentationer og PDF-filer i Nextcloud med ONLYOFFICE Docs.",
    "Learn more": "Læs mere",
    "Suggest a feature": "Foreslå en funktion",
    "Server settings have been successfully updated": "Serverindstillingerne er blevet opdateret",
    "Common settings have been successfully updated": "Generelle indstillinger er blevet opdateret",
    "Security settings have been successfully updated": "Sikkerhedsindstillingerne er blevet opdateret",
    "To ensure the security of important parameters in ONLYOFFICE Docs requests, please set a Secret Key on the Settings page. To learn more, <a href=\"{url}\" target=\"_blank\">click here</a>.": "For at sikre sikkerheden af vigtige parametre i ONLYOFFICE Docs-anmodninger, skal du angive en hemmelig nøgle på siden Indstillinger. For at lære mere, <a href=\"{url}\" target=\"_blank\">klik her</a>.",
    "Info": "Info",
    "Open": "Åbn",
    "%1$s could not be saved. Please open the file again.": "%1$s kunne ikke gemmes. Åbn venligst filen igen.",
    "{file} could not be saved. Please open the file again.": "{file} kunne ikke gemmes. Åbn venligst filen igen.",
    ...
    "Files. Mailing is completed with some errors.\n At least %1$s mail messages could not be sent. Please check the Mail module to review the reasons for the failure.": "Filer. Udsendelsen er afsluttet med nogle fejl.\n Mindst %1$s e-mails kunne ikke sendes. Kontroller venligst Mail-modulet for at gennemgå årsagerne til fejlen.",
