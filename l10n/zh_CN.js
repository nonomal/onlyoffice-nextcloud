OC.L10N.register(
    ...
    "Are you sure you want to clear metadata?": "您确定要清除元数据吗？",
    "Confirm metadata removal": "确认删除元数据",
    "Welcome to ONLYOFFICE Docs!": "欢迎使用 ONLYOFFICE 文档！",
    "Edit and collaborate on text documents, spreadsheets, presentations, and PDFs within Nextcloud using ONLYOFFICE Docs.": "在 Nextcloud 中使用 ONLYOFFICE 文档编辑和协作处理文本文档、电子表格、演示文稿和 PDF 文件。",
    "Learn more": "了解更多",
    ...
    "Restrict access to ONLYOFFICE for files from external storages": "限制使用 ONLYOFFICE 打开外部存储中的文件",
    ...
    "Limit access permissions for files shared with Custom permissions (Edit enabled, Share disabled) or via a public link with edit permission:": "限制通过“自定义权限”（允许编辑、禁止共享）或具有编辑权限的公共链接共享的文件访问权限：",
    "Document": "文档",
    "Review/Comment": "审阅/批注",
    "Spreadsheet": "电子表格",
    "Comment/Global filter": "批注/全局筛选器",
    "Presentation": "演示文稿",
    "Comment": "批注",
    "PDF": "PDF",
    "Comment/Form filling": "批注/填写表单",
    "Mailing is completed successfully": "邮件发送已成功完成",
    "Mailing is completed with some errors": "邮件发送完成，但存在一些错误",
