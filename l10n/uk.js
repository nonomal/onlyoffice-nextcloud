OC.L10N.register(
    ...
    "Show watermark on tagged files" : "Показувати водяний знак для позначених файлів",
    "Show watermark for users of groups" : "Показувати водяний знак для користувачів груп",
    "Supported placeholders" : "Підтримувані вставки",
    "Show watermark for all shares" : "Показувати водяний знак для всіх у спільному доступі",
    "Show watermark for read only shares" : "Показувати водяний знак при доступі тільки для читання",
    "Link shares" : "Доступ за посиланням",
    "Show watermark for all link shares" : "Показувати водяний знак при доступі за посиланням",
    "Show watermark for download hidden shares" : "Показувати водяний знак при доступі без звантаження",
    "Show watermark for read only link shares" : "Показувати водяний знак при доступі тільки для читання за посиланням",
    ...
    "Light": "Світла",
    "Dark": "Темна",
    "Review only": "Тільки рецензування",
    "Comment only": "Тільки коментування",
    ...
    "Are you sure you want to clear metadata?": "Ви впевнені, що хочете очистити метадані?",
    "Confirm metadata removal": "Підтвердьте видалення метаданих",
    "Welcome to ONLYOFFICE Docs!": "Ласкаво просимо до ONLYOFFICE Docs!",
    "Edit and collaborate on text documents, spreadsheets, presentations, and PDFs within Nextcloud using ONLYOFFICE Docs.": "Редагуйте та співпрацюйте над текстовими документами, таблицями, презентаціями та PDF-файлами в Nextcloud за допомогою ONLYOFFICE Docs.",
    "Learn more": "Дізнатися більше",
    "Suggest a feature": "Запропонувати функцію",
    "Server settings have been successfully updated": "Налаштування сервера успішно оновлено",
    "Common settings have been successfully updated": "Загальні налаштування успішно оновлено",
    "Security settings have been successfully updated": "Налаштування безпеки успішно оновлено",
    "To ensure the security of important parameters in ONLYOFFICE Docs requests, please set a Secret Key on the Settings page. To learn more, <a href=\"{url}\" target=\"_blank\">click here</a>.": "Щоб забезпечити безпеку важливих параметрів у запитах ONLYOFFICE Docs, будь ласка, встановіть секретний ключ на сторінці Налаштування. Щоб дізнатися більше, <a href=\"{url}\" target=\"_blank\">натисніть тут</a>.",
    "Info": "Інформація",
    "Open": "Відкрити",
    "%1$s could not be saved. Please open the file again.": "%1$s не вдалося зберегти. Будь ласка, відкрийте файл знову.",
    "{file} could not be saved. Please open the file again.": "{file} не вдалося зберегти. Будь ласка, відкрийте файл знову.",
    ...
    "Mailing is completed successfully": "Розсилку завершено успішно",
    "Mailing is completed with some errors": "Розсилку завершено з деякими помилками",
    "Files. Mailing is completed successfully": "Файли. Розсилку завершено успішно",
    "Files. Mailing is completed with some errors.\n At least %1$s mail messages could not be sent. Please check the Mail module to review the reasons for the failure.": "Файли. Розсилку завершено з деякими помилками.\n Щонайменше %1$s поштових повідомлень не вдалося надіслати. Будь ласка, перевірте модуль Пошта, щоб переглянути причини невдачі.",
    "You're receiving this email to confirm that your request to send %1$s messages has been completed. The successfully sent mail messages can be found in your <a href=\"%2$s\">Sent</a> folder of the Mail module.": "Ви отримуєте цей лист для підтвердження того, що ваш запит на надсилання %1$s повідомлень виконано. Успішно надіслані поштові повідомлення можна знайти у папці <a href=\"%2$s\">Надіслані</a> модуля Пошта.",
    "You're receiving this email to confirm that your request to send %1$s messages has been processed. However, %2$s messages could not be sent. Please check the Mail module to review the reasons for the failure.\nThe successfully sent mail messages can be found in your <a href=\"%3$s\">Sent</a> folder of the Mail module.": "Ви отримуєте цей лист для підтвердження того, що ваш запит на надсилання %1$s повідомлень було оброблено. Проте %2$s повідомлень не вдалося надіслати. Будь ласка, перевірте модуль Пошта, щоб переглянути причини невдачі.\nУспішно надіслані поштові повідомлення можна знайти у папці <a href=\"%3$s\">Надіслані</a> модуля Пошта.",
