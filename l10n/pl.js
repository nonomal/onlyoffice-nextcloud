OC.L10N.register(
    ...
    "Are you sure you want to clear metadata?": "Czy na pewno chcesz wyczyścić metadane?",
    "Confirm metadata removal": "Potwierdź usunięcie metadanych",
    "Welcome to ONLYOFFICE Docs!": "Witaj w ONLYOFFICE Docs!",
    "Edit and collaborate on text documents, spreadsheets, presentations, and PDFs within Nextcloud using ONLYOFFICE Docs.": "Edytuj i współpracuj nad dokumentami tekstowymi, arkuszami kalkulacyjnymi, prezentacjami i plikami PDF w Nextcloud za pomocą ONLYOFFICE Docs.",
    "Learn more": "Dowiedz się więcej",
    "Suggest a feature": "Zasugeruj funkcję",
    "Server settings have been successfully updated": "Ustawienia serwera zostały pomyślnie zaktualizowane",
    "Common settings have been successfully updated": "Ustawienia ogólne zostały pomyślnie zaktualizowane",
    "Security settings have been successfully updated": "Ustawienia zabezpieczeń zostały pomyślnie zaktualizowane",
    "To ensure the security of important parameters in ONLYOFFICE Docs requests, please set a Secret Key on the Settings page. To learn more, <a href=\"{url}\" target=\"_blank\">click here</a>.": "Aby zapewnić bezpieczeństwo ważnych parametrów w żądaniach ONLYOFFICE Docs, ustaw klucz tajny na stronie Ustawienia. Aby dowiedzieć się więcej, <a href=\"{url}\" target=\"_blank\">kliknij tutaj</a>.",
    "Info": "Informacje",
    "Open": "Otwórz",
    "%1$s could not be saved. Please open the file again.": "Nie można zapisać %1$s. Otwórz plik ponownie.",
    "{file} could not be saved. Please open the file again.": "Nie można zapisać {file}. Otwórz plik ponownie.",
    ...
    "Advanced permissions explanation": "Wyjaśnienie zaawansowanych uprawnień",
    "Limit access permissions for files shared with Custom permissions (Edit enabled, Share disabled) or via a public link with edit permission:": "Ogranicz uprawnienia dostępu dla plików udostępnionych z uprawnieniami niestandardowymi (edycja włączona, udostępnianie wyłączone) lub za pośrednictwem publicznego linku z uprawnieniem do edycji:",
    "Document": "Dokument",
    "Review/Comment": "Recenzja/Komentarz",
    "Spreadsheet": "Arkusz kalkulacyjny",
    "Comment/Global filter": "Komentarz/Filtr globalny",
    "Presentation": "Prezentacja",
    "Comment": "Komentarz",
    "PDF": "PDF",
    "Comment/Form filling": "Komentarz/Wypełnianie formularzy",
    "Mailing is completed successfully": "Wysyłka zakończona pomyślnie",
    "Mailing is completed with some errors": "Wysyłka zakończyła się z pewnymi błędami",
    "Files. Mailing is completed successfully": "Pliki. Wysyłka zakończona pomyślnie",
    "Files. Mailing is completed with some errors.\n At least %1$s mail messages could not be sent. Please check the Mail module to review the reasons for the failure.": "Pliki. Wysyłka zakończyła się z pewnymi błędami.\n Co najmniej %1$s wiadomości e-mail nie mogło zostać wysłanych. Prosimy sprawdzić moduł Poczta, aby przejrzeć przyczyny niepowodzenia.",
    "You're receiving this email to confirm that your request to send %1$s messages has been completed. The successfully sent mail messages can be found in your <a href=\"%2$s\">Sent</a> folder of the Mail module.": "Otrzymujesz tę wiadomość e-mail w celu potwierdzenia, że Twoje żądanie wysłania %1$s wiadomości zostało zrealizowane. Pomyślnie wysłane wiadomości e-mail znajdziesz w folderze <a href=\"%2$s\">Wysłane</a> modułu Poczta.",
    "You're receiving this email to confirm that your request to send %1$s messages has been processed. However, %2$s messages could not be sent. Please check the Mail module to review the reasons for the failure.\nThe successfully sent mail messages can be found in your <a href=\"%3$s\">Sent</a> folder of the Mail module.": "Otrzymujesz tę wiadomość e-mail w celu potwierdzenia, że Twoje żądanie wysłania %1$s wiadomości zostało przetworzone. Jednak %2$s wiadomości nie mogło zostać wysłanych. Prosimy sprawdzić moduł Poczta, aby przejrzeć przyczyny niepowodzenia.\nPomyślnie wysłane wiadomości e-mail można znaleźć w folderze <a href=\"%3$s\">Wysłane</a> modułu Poczta.",
    "Bad healthcheck status": "Nieprawidłowy status sprawdzania kondycji",
    "UserId is empty": "Identyfikator użytkownika jest pusty"
},
