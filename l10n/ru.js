OC.L10N.register(
    ...
    "FileId is empty": "Пустой идентификатор файла",
    ...
    "DO NOT SHARE THIS": "НЕ РАСПРОСТРАНЯЙТЕ ЭТО",
    ...
    "Template must be in OOXML format": "Шаблон должен быть в формате OOXML",
    ...
    "New PDF form": "Новая PDF-форма",
    "Blank": "Пустой",
    "From text document": "Из текстового документа",
    "Create new PDF form": "Создать новую PDF-форму",
    ...
    "Light": "Светлая",
    "Dark": "Темная",
    "Review only": "Только рецензирование",
    ...
    "Enable document protection for": "Включить возможность задавать пароль на документ",
    ...
    "Are you sure you want to clear metadata?": "Вы уверены, что хотите удалить метаданные?",
    "Confirm metadata removal": "Подтвердите удаление метаданных",
    "Welcome to ONLYOFFICE Docs!": "Добро пожаловать в ONLYOFFICE Docs!",
    "Edit and collaborate on text documents, spreadsheets, presentations, and PDFs within Nextcloud using ONLYOFFICE Docs.": "Редактируйте текстовые документы, электронные таблицы, презентации и PDF-файлы, а также работайте над ними вместе с другими пользователями в Nextcloud, используя ONLYOFFICE Docs.",
    "Learn more": "Узнать больше",
    "Suggest a feature": "Предложить функцию",
    "Server settings have been successfully updated": "Настройки сервера успешно обновлены",
    "Common settings have been successfully updated": "Общие настройки успешно обновлены",
    "Security settings have been successfully updated": "Настройки безопасности успешно обновлены",
    "To ensure the security of important parameters in ONLYOFFICE Docs requests, please set a Secret Key on the Settings page. To learn more, <a href=\"{url}\" target=\"_blank\">click here</a>.": "Для обеспечения безопасности важных параметров в запросах ONLYOFFICE Docs, пожалуйста, установите секретный ключ на странице настроек. Чтобы узнать больше, <a href=\"{url}\" target=\"_blank\">перейдите по ссылке</a>.",
    "Info": "Информация",
    "Open": "Открыть",
    "%1$s could not be saved. Please open the file again.": "Не удалось сохранить файл %1$s. Откройте файл еще раз.",
    "{file} could not be saved. Please open the file again.": "Не удалось сохранить файл {file}. Откройте файл еще раз.",
    "The user who creates a public link sets its access permissions": "Пользователь, создающий публичную ссылку, устанавливает права доступа к ней",
    "Restrict access to ONLYOFFICE for files from external storages": "Ограничить доступ к ONLYOFFICE для файлов из внешних хранилищ",
    "Opening files with ONLYOFFICE from external storages is restricted. Please contact the admin.": "Открытие файлов в ONLYOFFICE из внешних хранилищ ограничено. Пожалуйста, обратитесь к администратору.",
    "Advanced permissions explanation": "Пояснение расширенных разрешений",
    "Limit access permissions for files shared with Custom permissions (Edit enabled, Share disabled) or via a public link with edit permission:": "Ограничьте права доступа для файлов, переданных с пользовательскими разрешениями (редактирование включено, общий доступ отключен) или через публичную ссылку с правом редактирования:",
    "Document": "Документ",
    "Review/Comment": "Рецензирование/Комментирование",
    "Spreadsheet": "Электронная таблица",
    "Comment/Global filter": "Комментирование/Глобальный фильтр",
    ...
    "You're receiving this email to confirm that your request to send %1$s messages has been completed. The successfully sent mail messages can be found in your <a href=\"%2$s\">Sent</a> folder of the Mail module.": "Вы получили это письмо для подтверждения выполнения вашего запроса на отправку %1$s сообщений. Успешно отправленные письма можно найти в папке <a href=\"%2$s\">Отправленные</a> почтового модуля.",
    "You're receiving this email to confirm that your request to send %1$s messages has been processed. However, %2$s messages could not be sent. Please check the Mail module to review the reasons for the failure.\nThe successfully sent mail messages can be found in your <a href=\"%3$s\">Sent</a> folder of the Mail module.": "Вы получили это письмо для подтверждения обработки вашего запроса на отправку %1$s сообщений. Однако %2$s сообщений не удалось отправить. Пожалуйста, проверьте почтовый модуль для ознакомления с причинами сбоев.\nУспешно отправленные письма можно найти в папке <a href=\"%3$s\">Отправленные</a> почтового модуля.",
    "Bad healthcheck status": "Неверный статус проверки работоспособности",
    "UserId is empty": "Идентификатор пользователя пуст"
},
