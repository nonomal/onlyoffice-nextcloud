OC.L10N.register(
    ...
    "Are you sure you want to clear metadata?": "Är du säker på att du vill rensa metadata?",
    "Confirm metadata removal": "Bekräfta borttagning av metadata",
    "Welcome to ONLYOFFICE Docs!": "Välkommen till ONLYOFFICE Docs!",
    "Edit and collaborate on text documents, spreadsheets, presentations, and PDFs within Nextcloud using ONLYOFFICE Docs.": "Redigera och samarbeta kring textdokument, kalkylblad, presentationer och PDF:er i Nextcloud med ONLYOFFICE Docs.",
    "Learn more": "Läs mer",
    "Suggest a feature": "Föreslå en funktion",
    "Server settings have been successfully updated": " Serverinställningarna har uppdaterats",
    "Common settings have been successfully updated": "Allmänna inställningar har uppdaterats",
    "Security settings have been successfully updated": "Säkerhetsinställningarna har uppdaterats",
    "To ensure the security of important parameters in ONLYOFFICE Docs requests, please set a Secret Key on the Settings page. To learn more, <a href=\"{url}\" target=\"_blank\">click here</a>.": "För att säkerställa säkerheten för viktiga parametrar i ONLYOFFICE Docs-förfrågningar, ange en hemlig nyckel på sidan Inställningar. För att lära dig mer, <a href=\"{url}\" target=\"_blank\">klicka här</a>.",
    "Info": "Info",
    "Open": "Öppna",
    "%1$s could not be saved. Please open the file again.": "%1$s kunde inte sparas. Öppna filen igen.",
    "{file} could not be saved. Please open the file again.": "{file} kunde inte sparas. Öppna filen igen.",
    "The user who creates a public link sets its access permissions": "Användaren som skapar en offentlig länk anger dess åtkomstbehörigheter",
    "Restrict access to ONLYOFFICE for files from external storages": "Begränsa åtkomst till ONLYOFFICE för filer från externa lagringar",
    "Opening files with ONLYOFFICE from external storages is restricted. Please contact the admin.": "Att öppna filer med ONLYOFFICE från externa lagringar är begränsat. Kontakta administratören.",
    "Advanced permissions explanation": "Förklaring av avancerade behörigheter",
    "Limit access permissions for files shared with Custom permissions (Edit enabled, Share disabled) or via a public link with edit permission:": "Begränsa åtkomstbehörigheter för filer delade med anpassade behörigheter (redigering aktiverad, delning inaktiverad) eller via en offentlig länk med redigeringsbehörighet:",
    "Document": "Dokument",
    "Review/Comment": "Granskning/Kommentar",
    "Spreadsheet": "Kalkylblad",
    "Comment/Global filter": "Kommentar/Globalt filter",
    "Presentation": "Presentation",
    "Comment": "Kommentar",
    "PDF": "PDF",
    "Comment/Form filling": "Kommentar/Formulärifyllning",
    "Mailing is completed successfully": "Utskicket har slutförts",
    "Mailing is completed with some errors": "Utskicket slutfördes med vissa fel",
