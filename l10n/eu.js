OC.L10N.register(
    ...
    "Comment only": "Iruzkina bakarrik",
    ...
    "Are you sure you want to clear metadata?": "Ziur zaude metadatuak garbitu nahi dituzula?",
    "Confirm metadata removal": "Berretsi metadatuen ezabaketa",
    "Welcome to ONLYOFFICE Docs!": "Ongi etorri ONLYOFFICE Docs-era!",
    "Edit and collaborate on text documents, spreadsheets, presentations, and PDFs within Nextcloud using ONLYOFFICE Docs.": "Editatu eta lankidetzan aritu testu-dokumentuetan, kalkulu-orrietan, aurkezpenetan eta PDF-etan Nextcloud-en barnean ONLYOFFICE Docs erabiliz.",
    "Learn more": "Gehiago ikasi",
    "Suggest a feature": "Proposatu ezaugarri bat",
    "Server settings have been successfully updated": "Zerbitzariaren ezarpenak eguneratu dira arrakastaz",
    "Common settings have been successfully updated": "Ezarpen orokorrak eguneratu dira arrakastaz",
    "Security settings have been successfully updated": "Segurtasun-ezarpenak eguneratu dira arrakastaz",
    "To ensure the security of important parameters in ONLYOFFICE Docs requests, please set a Secret Key on the Settings page. To learn more, <a href=\"{url}\" target=\"_blank\">click here</a>.": "ONLYOFFICE Docs eskaeretan parametro garrantzitsuen segurtasuna bermatzeko, mesedez ezarri Gako Sekretua Ezarpenak orrialdean. Gehiago jakiteko, <a href=\"{url}\" target=\"_blank\">egin klik hemen</a>.",
    "Info": "Informazioa",
    "Open": "Ireki",
    "%1$s could not be saved. Please open the file again.": "%1$s ezin izan da gorde. Mesedez ireki fitxategia berriro.",
    "{file} could not be saved. Please open the file again.": "{file} ezin izan da gorde. Mesedez ireki fitxategia berriro.",
    "The user who creates a public link sets its access permissions": "Esteka publikoa sortzen duen erabiltzaileak sarbide-baimenak ezartzen ditu",
    "Restrict access to ONLYOFFICE for files from external storages": "Mugatu ONLYOFFICE-rako sarbidea kanpoko biltegietako fitxategietarako",
    "Opening files with ONLYOFFICE from external storages is restricted. Please contact the admin.": "Kanpoko biltegietako fitxategiak ONLYOFFICE-rekin irekitzea mugatuta dago. Mesedez, jarri harremanetan administratzailearekin.",
    "Advanced permissions explanation": "Baimen aurreratuen azalpena",
    "Limit access permissions for files shared with Custom permissions (Edit enabled, Share disabled) or via a public link with edit permission:": "Mugatu sarbide-baimenak fitxategietarako, pertsona bakoitzarentzako baimenarekin (editatzea gaituta, partekatzea desgaituta) edo esteka publiko baten bidez editatzeko baimenarekin:",
    "Document": "Dokumentua",
    "Review/Comment": "Berrikuspena/Iruzkina",
    "Spreadsheet": "Kalkulu-orria",
    "Comment/Global filter": "Iruzkina/Filtro globala",
    "Presentation": "Aurkezpena",
    "Comment": "Iruzkina",
    "PDF": "PDF",
    "Comment/Form filling": "Iruzkina/Inprimakia bete",
