OC.L10N.register(
    ...
    "Enable document protection for": "Documentbeveiliging inschakelen voor",
    "All users": "Alle gebruikers",
    "Owner only": "Alleen eigenaar",
    "Authorization header (leave blank to use default header)": "Autorisatieheader (laat leeg om de standaard header te gebruiken)",
    "ONLYOFFICE server is not available": "ONLYOFFICE server is niet beschikbaar",
    "Please check the settings to resolve the problem.": "Controleer de instellingen om het probleem op te lossen.",
    ...
    "Unknown author display name": "Onbekende auteursnaam",
    "Enable e-mail notifications": "E-mailmeldingen inschakelen",
    "You were mentioned in the document": "Je werd in het document genoemd.",
    "%1$s mentioned you in the document comment": "%1$s heeft je genoemd in de opmerking bij het document",
    "This is a mail message to notify that you have been mentioned by <a href=\"%1$s\">%2$s</a> in the comment to the <a href=\"%3$s\">%4$s</a>:<br>\"%5$s\"": "Dit is een e-mailbericht om te melden dat u bent genoemd door <a href=\"%1$s\">%2$s</a> in de reactie op <a href=\"%3$s\">%4$s</a>:<br>\"%5$s\"",
    "Open file": "Open bestand",
    "ONLYOFFICE Document Server is unavailable": "ONLYOFFICE Document Server is niet beschikbaar",
    "This is a mail message to notify that the connection with the ONLYOFFICE Document Server has been lost. Please check the connection settings:": "Dit is een e-mailbericht om te melden dat de verbinding met de ONLYOFFICE Document Server verbroken is. Controleer de verbindingsinstellingen:",
    "Go to Settings": "Ga naar Instellingen",
    "Select file to insert text": "Bestand selecteren om tekst in te voegen",
    ...
    "Are you sure you want to clear metadata?": "Weet u zeker dat u de metadata wilt wissen?",
    "Confirm metadata removal": "Bevestig het verwijderen van metadata",
    "Welcome to ONLYOFFICE Docs!": "Welkom bij ONLYOFFICE Docs!",
    "Edit and collaborate on text documents, spreadsheets, presentations, and PDFs within Nextcloud using ONLYOFFICE Docs.": "Bewerk en werk samen aan tekstdocumenten, spreadsheets, presentaties en PDF's binnen Nextcloud met ONLYOFFICE Docs.",
    "Learn more": "Meer informatie",
    "Suggest a feature": "Stel een functie voor",
    "Server settings have been successfully updated": "Serverinstellingen zijn succesvol bijgewerkt",
    "Common settings have been successfully updated": "Algemene instellingen zijn succesvol bijgewerkt",
    "Security settings have been successfully updated": "Beveiligingsinstellingen zijn succesvol bijgewerkt",
    "To ensure the security of important parameters in ONLYOFFICE Docs requests, please set a Secret Key on the Settings page. To learn more, <a href=\"{url}\" target=\"_blank\">click here</a>.": "Om de beveiliging van belangrijke parameters in ONLYOFFICE Docs-verzoeken te garanderen, stelt u een geheime sleutel in op de pagina Instellingen. Voor meer informatie, <a href=\"{url}\" target=\"_blank\">klik hier</a>.",
    "Info": "Info",
    "Open": "Openen",
    "%1$s could not be saved. Please open the file again.": "%1$s kon niet worden opgeslagen. Open het bestand opnieuw.",
    "{file} could not be saved. Please open the file again.": "{file} kon niet worden opgeslagen. Open het bestand opnieuw.",
    ...
    "Files. Mailing is completed with some errors.\n At least %1$s mail messages could not be sent. Please check the Mail module to review the reasons for the failure.": "Bestanden. Het verzenden is voltooid met enkele fouten.\n Minstens %1$s e-mailberichten konden niet worden verzonden. Controleer de Mailmodule om de redenen voor de mislukking te bekijken.",
    "You're receiving this email to confirm that your request to send %1$s messages has been completed. The successfully sent mail messages can be found in your <a href=\"%2$s\">Sent</a> folder of the Mail module.": "U ontvangt deze e-mail ter bevestiging dat uw verzoek om %1$s berichten te verzenden is voltooid. De succesvol verzonden e-mailberichten zijn te vinden in uw map <a href=\"%2s\">Verzonden</a> van de Mailmodule.",
    "You're receiving this email to confirm that your request to send %1$s messages has been processed. However, %2$s messages could not be sent. Please check the Mail module to review the reasons for the failure.\nThe successfully sent mail messages can be found in your <a href=\"%3$s\">Sent</a> folder of the Mail module.": "U ontvangt deze e-mail ter bevestiging dat uw verzoek om %1$s berichten te verzenden is verwerkt. %2$s berichten konden echter niet worden verzonden. Controleer de Mailmodule om de redenen voor de mislukking te bekijken.\nDe succesvol verzonden e-mailberichten zijn te vinden in uw map <a href=\"%3$s\">Verzonden</a> van de Mailmodule.",
    "Bad healthcheck status": "Ongeldige healthcheck-status",
