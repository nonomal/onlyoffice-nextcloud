OC.L10N.register(
    ...
    "Are you sure you want to clear metadata?": "Esteu segurs que voleu esborrar les metadades?",
    "Confirm metadata removal": "Confirmeu l'eliminació de les metadades",
    "Welcome to ONLYOFFICE Docs!": "Benvinguts a ONLYOFFICE Docs!",
    "Edit and collaborate on text documents, spreadsheets, presentations, and PDFs within Nextcloud using ONLYOFFICE Docs.": "Editeu i col·laboreu en documents de text, fulls de càlcul, presentacions i PDF dins de Nextcloud amb ONLYOFFICE Docs.",
    "Learn more": "Més informació",
    "Suggest a feature": "Suggereix una funcionalitat",
    "Server settings have been successfully updated": "La configuració del servidor s'ha actualitzat correctament",
    "Common settings have been successfully updated": "La configuració general s'ha actualitzat correctament",
    "Security settings have been successfully updated": "La configuració de seguretat s'ha actualitzat correctament",
    "To ensure the security of important parameters in ONLYOFFICE Docs requests, please set a Secret Key on the Settings page. To learn more, <a href=\"{url}\" target=\"_blank\">click here</a>.": "Per garantir la seguretat dels paràmetres importants en les sol·licituds de ONLYOFFICE Docs, si us plau establiu una clau secreta a la pàgina de configuració. Per obtenir més informació, <a href=\"{url}\" target=\"_blank\">feu clic aquí</a>.",
    "Info": "Informació",
    "Open": "Obre",
    "%1$s could not be saved. Please open the file again.": "No s'ha pogut desar %1$s. Si us plau, torneu a obrir el fitxer.",
    "{file} could not be saved. Please open the file again.": "No s'ha pogut desar {file}. Si us plau, torneu a obrir el fitxer.",
    "The user who creates a public link sets its access permissions": "L'usuari que crea un enllaç públic estableix els seus permisos d'accés",
    "Restrict access to ONLYOFFICE for files from external storages": "Restringeix l'accés a ONLYOFFICE per a fitxers d'emmagatzematges externs",
    "Opening files with ONLYOFFICE from external storages is restricted. Please contact the admin.": "L'obertura de fitxers amb ONLYOFFICE des d'emmagatzematges externs està restringida. Poseu-vos en contacte amb l'administrador.",
    "Advanced permissions explanation": "Explicació dels permisos avançats",
    "Limit access permissions for files shared with Custom permissions (Edit enabled, Share disabled) or via a public link with edit permission:": "Limiteu els permisos d'accés per a fitxers compartits amb permisos personalitzats (edició habilitada, compartició deshabilitada) o mitjançant un enllaç públic amb permís d'edició:",
    "Document": "Document",
    "Review/Comment": "Revisió/Comentari",
    "Spreadsheet": "Full de càlcul",
    "Comment/Global filter": "Comentari/Filtre global",
    "Presentation": "Presentació",
    "Comment": "Comentari",
    "PDF": "PDF",
    "Comment/Form filling": "Comentari/Emplenament de formularis",
    "Mailing is completed successfully": "L'enviament s'ha completat correctament",
    "Mailing is completed with some errors": "L'enviament s'ha completat amb alguns errors",
    "Files. Mailing is completed successfully": "Fitxers. L'enviament s'ha completat correctament",
    "Files. Mailing is completed with some errors.\n At least %1$s mail messages could not be sent. Please check the Mail module to review the reasons for the failure.": "Fitxers. L'enviament s'ha completat amb alguns errors.\n Com a mínim %1$s missatges de correu no s'han pogut enviar. Consulteu el mòdul de correu per revisar els motius de l'error.",
